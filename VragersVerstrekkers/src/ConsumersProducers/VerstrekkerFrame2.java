 ...
 */
public class VerstrekkerFrame2 extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    VerstrekkerFrame2 frame = new VerstrekkerFrame2();
    ...
    public VerstrekkerFrame2() {
        ...
        VerstrekkerDrie = new Gateway("VerstrekkerDrie.LastBroker", "VerstrekkerDrie.VerstrekkerReply", "VerstrekkerDrie") {
            @Override
            public void messageReceived(RequestReply rr) {
                //aggregator(rr);
        ...
        btnSendReplyTwo.addActionListener(
            ...
            public void actionPerformed(ActionEvent e
                ...
                //list.repaint();
                listTwo.repaint();
                VerstrekkerDrie.postMessage(rrTwo);
            }
        }
        );
