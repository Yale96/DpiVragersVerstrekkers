 ...
 */
public class Leasing extends JFrame {
    ...
    public Leasing() {
        ...
        Leasing = new Gateway("Leasing.LastBroker", "Leasing.VerstrekkerReply", "Leasing") {
            @Override
            public void messageReceived(RequestReply rr) {
                //aggregator(rr);
